...
public class Habitacion implements Contenedor {
     ...
     */
    public String getDescripcionLarga() { // TODO - Modificar metodo
        String str = lugar.getDescripcion() + "\n";
        if (derramado != null) {
            str += "Se ha derramado " + derramado + " en el piso\n";
        }
        str += getStringDeSalidas() + "\n";
        str += getStringDeElementos() + "\n";
    ...
    public Habitacion getSalida(Salida direccion) throws AccionNoPermitidaException {
        Habitacion habitacion = salidas.get(direccion);
        if (habitacion == null) {
     ...
     *                                    con el mensaje: "No hay elementos en la
     *                                    habitacion".
     * @throws AccionNoPermitidaException En caso que el elemento no exista
     *                                    con el mensaje: "No existe el elemento
     *                                    <nombre>"
    ...
    private class ConElementos extends EstadoContenedor {
        ...
        public Elemento getElemento() throws ContenedorVacioException, AccionNoPermitidaException {
            if (elementos.size() == 1) {
                estado = new Vacia();
                return elementos.pollFirstEntry().getValue();
            }
        ...
        public String toString() {
            ...
            String allKeys = sb.toString().trim();
